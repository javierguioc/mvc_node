...
async function postFunction(req, res, next) {
    ...
    `);
        ...
        let insertFunctionality = `insert into funcionalidad(fun_nombre,fun_ruta,fun_descripcion,mod_id) values ('${req.body.fun_nombre}','${req.body.fun_ruta}','${req.body.fun_descripcion}',${req.body.mod_id});
    `;
