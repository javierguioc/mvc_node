...
class ClaseModeloGeneral {
   ...
   * @param {string} tabla  Nombre que identifica la tabla a listar
   * @return {Object} Devuelve un HashMap con la respuesta de la base de datos
   */
   ...
   *
   * @param {string} tabla Nombre que identifica la tabla a listar
   * @param {string} campos Contiene el identificador por el cual se va a filtrar
   * @param {Object} datos Informacion que contiene los registros del formulario a
   * listar
   * @return {Object}  Devuelve un HashMap con la respuesta de la base de datos
   */
   ...
   *
   * @param {string} tabla Nombre de la tabla a la que se le eliminará el registro
   * @param {string} campos campo que identifica al registro que se va a eliminar
   * @param {Object} datos HashMap que contiene el boton eliminar y el campo a eliminar
   * @return {Object}  Devuelve un HashMap con la respuesta de la base de datos
   */
   ...
   * especificada
   *
   * @param {string} campos Campos que contienen la informacion a agregar
   * @param {Object} datos Campos provenientes del formulario
   * @return {Object}  Devuelve un HashMap con la respuesta de la base de datos
   */
   ...
   * especificada
   *
   * @param {string} tabla Nombre de la tabla a la cual se le realizarán los cambios
   * @param {string} campos Campos que contienen la informacion a actualiar
   * @param {Object} datos Campos provenientes del formulario
   * @return {Object}  Devuelve un HashMap con la respuesta de la base de datos
   */
   ...
   * @param {string} estructura Estructura SQL que sera ejecutada
   * @return {Object}  Devuelve un HashMap con la respuesta de la base de datos
   */
