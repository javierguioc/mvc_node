...
module.exports = async function (res, datos) {
  ...
  res.write(`
    ...
    <BODY>          
        ...
        ${vista.formulario(
          `${datos.mod_id}:mod_id: :hidden,${datos.functionality.fun_id}:fun_id: :hidden,${datos.functionality.fun_nombre}:fun_nombre:Nombre:text,${datos.functionality.fun_ruta}:fun_ruta:Ruta:text,${datos.functionality.fun_descripcion}:fun_descripcion:Descripcion:text`
        )}
